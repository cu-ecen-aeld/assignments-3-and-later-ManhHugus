...
cp "SYSROOT/ld-linux-aarch64.so.1" "${ROOTFS}/lib"
cp "SYSROOT/libm.so.6" "${ROOTFS}/lib64"
cp "SYSROOT/libresolv.so.2" "${ROOTFS}/lib64"
cp "SYSROOT/libc.so.6" "${ROOTFS}/lib64"
